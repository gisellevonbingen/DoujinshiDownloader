...
namespace Giselle.DoujinshiDownloader.Forms.Utils
{
    ...
    {
        public static Rectangle PlaceByDirection(this Rectangle master, Size slave, PlaceDirection direction)
        {
            return new Rectangle(DrawingUtils.PlaceByDirection(master, slave, direction), slave);
        }

        public static Rectangle PlaceByDirection(this Rectangle master, Size slave, PlaceDirection direction, int margin)
        {
            return new Rectangle(DrawingUtils.PlaceByDirection(master, slave, direction, margin), slave);
        }

        public static Rectangle PlaceByDirection(this Rectangle master, Size slave, PlaceDirection direction, PlaceLevel level)
        {
            return new Rectangle(DrawingUtils.PlaceByDirection(master, slave, direction, level), slave);
        }

        public static Rectangle PlaceByDirection(this Rectangle master, Size slave, PlaceDirection direction, PlaceLevel level, int margin)
        {
